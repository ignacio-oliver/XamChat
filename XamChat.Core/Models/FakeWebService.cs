...
namespace XamChat.Core
{
    public class FakeWebService : IWebService
    {
        ...
        public async Task<Message[]> GetMessages(string conversationId)
        {
            ...
            return new[]
            {
                new Message{Id = "1", ConversationId = conversationId, UserId = "2", Text="Hey", Date=DateTime.Now.AddMinutes(-15)},
                new Message{Id = "2", ConversationId = conversationId, UserId = "1", Text="What's Up?", Date=DateTime.Now.AddMinutes(-10)},
                new Message{Id = "3", ConversationId = conversationId, UserId = "2", Text="Have you seen that new movie?", Date=DateTime.Now.AddMinutes(-5)},
                new Message{Id = "4", ConversationId = conversationId, UserId = "1", Text="It's great!", Date=DateTime.Now}
            };
        }
